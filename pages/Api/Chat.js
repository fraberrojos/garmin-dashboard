export default async function handler(req, res) {
  ...
  const prompt = `Eres un entrenador personal experto. El usuario te hace una pregunta basada en sus datos de bienestar.
...
PERFIL: Principiante, interesado en ciclismo, correr y fuerza.
